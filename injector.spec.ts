import { Optional } from './packages/common';
import * as chai from 'chai';
import { expect } from 'chai';
import * as chaiAsPromised from 'chai-as-promised';
import * as sinon from 'sinon';
import { Inject } from './packages/common/decorators/core/inject.decorator';
import { Injectable } from './packages/common/decorators/core/injectable.decorator';
import { STATIC_CONTEXT } from './packages/core/injector/constants';
import { NestContainer } from './packages/core/injector/container';
import {
  Injector,
  PropertyDependency,
} from './packages/core/injector/injector';
import { InstanceWrapper } from './packages/core/injector/instance-wrapper';
import { Module } from './packages/core/injector/module';
import { PARAMTYPES_METADATA } from './packages/common/constants';
